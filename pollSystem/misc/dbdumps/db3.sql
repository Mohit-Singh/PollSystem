...
INSERT INTO `login` VALUES (1,'test@gmail.com','827ccb0eea8a706c4c34a16891f84e7b','TRUE','test','test',NULL),(2,'test1@gmail.com','827ccb0eea8a706c4c34a16891f84e7b','TRUE','test','test',NULL);
...
CREATE TABLE `question` (
  ...
  PRIMARY KEY (`id`),
  KEY `login_username` (`login_username`),
  CONSTRAINT `question_ibfk_1` FOREIGN KEY (`login_username`) REFERENCES `login` (`username`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-06-03 13:53:56
